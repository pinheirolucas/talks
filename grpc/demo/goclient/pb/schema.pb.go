...
var file_schema_proto_rawDesc = []byte{
	...
	0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0x46, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52,
	...
	0x65, 0x6e, 0x32, 0x45, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x36, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x14, 0x2e, 0x73, 0x63, 0x68,
	0x65, 0x6d, 0x61, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x15, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0b, 0x5a, 0x09, 0x63, 0x6c, 0x69,
...
var file_schema_proto_goTypes = []interface{}{
	(*LoginRequest)(nil),  // 0: schema.LoginRequest
	(*LoginResponse)(nil), // 1: schema.LoginResponse
}
var file_schema_proto_depIdxs = []int32{
	0, // 0: schema.AuthService.Login:input_type -> schema.LoginRequest
	1, // 1: schema.AuthService.Login:output_type -> schema.LoginResponse
...
func (c *authServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/schema.AuthService/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/schema.AuthService/Login",
	}
...
var _AuthService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "schema.AuthService",
